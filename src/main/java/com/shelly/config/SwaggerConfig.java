...
public class SwaggerConfig {
    private static final String API_TILE = "基于springboot的个人blog系统";
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.shelly.controller"))
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("基于springboot的个人blog系统")
                        .version("1.0"));
    }
}
